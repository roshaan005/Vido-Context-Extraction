...
def save_text_to_speech(text, speaker=None):
    ...
    if speaker is not None:
        ...
        output_filedirectory = f"/home/jetson/VMS/GUI2CHjetson/Stream2_searchword1/"
        output_filename = f"/home/jetson/VMS/GUI2CHjetson/Stream2_searchword1/{speaker}-{'-'.join(text.split()[:6])}.wav"
